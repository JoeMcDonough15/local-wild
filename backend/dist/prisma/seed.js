...
async function main() {
    await prisma.user.createMany({
        data: [
            ...
            },
            {
                ...
                aboutMe: "I’m a nature enthusiast and self-taught wildlife photographer, captivated by the wonders of the animal world. My camera is my way of connecting with the outdoors, and I love capturing moments that reveal the beauty and complexity of wildlife. Whether I’m tracking elusive creatures or simply observing a bird in flight, every photo tells a story. While photography is a hobby, I hope my images spark curiosity and appreciation for the natural world, encouraging others to protect the creatures we share this planet with.",
            },
            {
                ...
                location: "Upstate NY",
                aboutMe: "I’ve always had a deep love for nature, and wildlife photography allows me to share that passion with others. As an avid photographer, I spend countless hours in the field, seeking out animals and moments that reflect the quiet elegance of the wild. My goal is to capture images that show the intimate side of wildlife—whether it’s a deer in the mist or a hawk soaring high. I may not be a professional, but through my photos, I hope to inspire others to look closer and see the beauty of the creatures around us.",
            },
            {
            ...
            },
            {
                ...
                aboutMe: "Wildlife photography is a way for me to merge my love of nature with my passion for storytelling. I’m an avid hobbyist who spends as much time as I can outdoors, photographing the animals I encounter along the way. From the smallest creatures to the most majestic, each subject has a story to tell, and I strive to capture those moments authentically. Through my images, I hope to inspire others to appreciate the fragile beauty of the natural world and work toward its protection.",
            },
            {
                email: "tom@prisma.io",
                name: "Tom",
            ...
            },
            {
                ...
                aboutMe: "Photography allows me to get closer to the wild than I ever thought possible. As a hobbyist wildlife photographer, I spend my free time in nature, camera in hand, seeking out animals in their natural habitats. I’m particularly drawn to the subtle details that often go unnoticed—whether it’s a bird’s feather pattern or the way light hits a leopard’s coat. My goal is to share these moments with others and spark a greater appreciation for wildlife and conservation.",
            },
        ],
    });
        ...
        data: [
            {
                ...
                fullDescription: "I captured this shot while on vacation in Pennsylvania.  I couldn't believe my luck.  The hawk came from out of nowhere.  Luckily I still had my camera out and was able to get a few shots before the bird flew too far away.  The focus is not great but I am still so grateful for the shot",
            ...
            },
            {
                ...
                partOfDay: "Mid morning",
                fullDescription: "Got this picture of a bird right in my backyard while I was eating breakfast.  Luckily, my camera was not far and I was able to get a few photos before the bird flew away.",
    ...
    await prisma.commentOnPost.createMany({
        data: [
            ...
            {
                commentText: "Absolutely love how you captured the essence of this animal.",
                commenterId: 4,
                postId: 3,
            },
            {
            ...
            {
                commentText: "Nature is full of surprises, and this one is spectacular.",
                commenterId: 4,
                postId: 4,
            },
            {
            ...
            {
                commentText: "This image really brings out the power and majesty of wildlife.",
                commenterId: 8,
                postId: 6,
            },
            ...
            {
                commentText: "You’ve captured the wild’s essence perfectly with this one.",
                commenterId: 5,
                postId: 6,
            },
            {
            ...
            {
                commentText: "What a stunning shot—this animal’s elegance shines through.",
                commenterId: 1,
                postId: 6,
            },
            {
            ...
            {
                commentText: "This picture perfectly shows the delicate balance of the wild.",
                commenterId: 7,
                postId: 8,
            },
            {
                commenterId: 6,
                commentText: "What an awe-inspiring animal, and you’ve captured it beautifully.",
                postId: 8,
            },
            {
            ...
            {
                commentText: "This photo makes you stop and appreciate nature’s wonders.",
                commenterId: 2,
                postId: 8,
            },
            {
                commentText: "You’ve perfectly captured the harmony between wildlife and its environment.",
                commenterId: 3,
                postId: 8,
            },
            {
            ...
            {
                commentText: "Such a stunning shot of this animal in its natural habitat!",
                commenterId: 8,
                postId: 9,
            },
            {
            ...
            {
                commentText: "What an intense, powerful shot—this animal's presence is undeniable!",
                commenterId: 5,
                postId: 9,
            },
            {
            ...
            {
                commentText: "The lighting adds so much depth—what an extraordinary photo.",
                commenterId: 3,
                postId: 9,
            },
            {
            ...
            {
                commentText: "Every detail is so crisp and vivid—such a beautiful image!",
                commenterId: 8,
                postId: 10,
            },
            {
                commentText: "This is pure magic! You’ve captured the heart of the wild.",
                commenterId: 7,
                postId: 10,
            },
            {
            ...
            {
                commentText: "You’ve captured the wild in such a unique way. Love this!",
                commenterId: 5,
                postId: 10,
            },
            {
            ...
            {
                commentText: "The colors are so vivid, it almost feels like you’re there.",
                commenterId: 5,
                postId: 11,
            },
            {
            ...
            {
                commentText: "Such a beautiful and rare moment to witness—great capture!",
                commenterId: 3,
                postId: 11,
            },
            {
            ...
            {
                commentText: "This moment feels so intimate, almost like we’re a part of it.",
                commenterId: 5,
                postId: 12,
            },
            {
            ...
            {
                commentText: "The way this light falls on the animal is simply gorgeous.",
                commenterId: 5,
                postId: 13,
            },
            {
            ...
            {
                commentText: "This is a perfect example of how beautiful nature can be.",
                commenterId: 5,
                postId: 14,
            },
            {
                commentText: "Such an incredible shot—like something out of a wildlife documentary!",
                commenterId: 6,
                postId: 14,
            },
            {
                commentText: "This is the kind of moment that makes you fall in love with nature.",
                commenterId: 7,
                postId: 14,
            },
            {
            ...
            {
                commentText: "The way the animal blends with its surroundings is just perfect.",
                commenterId: 3,
                postId: 15,
            },
            {
